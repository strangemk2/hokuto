...
hoku3 : hoku3.cpp hoku1.hpp hoku_picture.o hoku_screenshot.o hoku_font.o hoku_matching.o
	 g++ hoku3.cpp hoku_picture.o  hoku_matching.o hoku_font.o hoku_screenshot.o -std=c++11 -Wall -g -lpng -o hoku3
...
hoku_font.o : hoku_font.hpp hoku_font.cpp hoku_common.hpp
	g++ hoku_font.cpp -std=c++11 -Wall -g -c -DSPECIAL_PATCH -DPREDEFINED_FONT_DATA
